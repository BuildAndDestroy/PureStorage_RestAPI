...
class ListFlashArray(FlashArray):
    ...
    def __init__(self, volumes=None, drives=None, alert_distro=None, initiators=None, initiator_connections=None, hgroup_connect=None, connect=None, host=None, hgroup=None, snapshot=None, pgroup=None, api_tokens=None):
        # super().__init__()
...
class DestroyFlashArray(FlashArray):
    ...
    def destroy_volume(self):
        ...
        for volume in self.volumes:
            ...
            print(f'\n[*] Volume {volume} has been destroyed!')
